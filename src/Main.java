...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Conteúdos Inscritos Camila" + devVania.getConteudosInscritos());
        devVania.progredir();
        devVania.progredir();
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Camila" + devVania.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Camila" + devVania.getConteudosConcluidos());
